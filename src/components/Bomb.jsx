...
const Bomb = (props) => {
    ...
    const bombModel = 
        <g className="bombBody" id={props.timeCreated} onClick={handleClick} filter={props.selected ? "url(#bombShadow)" : ""} strokeWidth="2px" fill="url(#bombGradient)" stroke="rgb(50, 50, 50)">
